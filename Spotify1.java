...
public static void main(String[] args)
{
	...
	System.out.println("SELECT YOUR SONG TYPE");
	...
	if(sing==1)
	{
	System.out.print("SELECT YOUR TYPE SONG: ");
	int type= sc.nextInt();
	}
	if (song==1)
	{
	System.out.print("SELECT YOUR MELODY SONG: ");
	...
	{
	System.out.print("SELECT YOUR KUTHU SONG: ");
	...
	{
	System.out.print("SELECT YOUR MOTIVATIONAL SONG: ");
	...
	{
	System.out.print("SELECT YOUR SAD SONG: ");
